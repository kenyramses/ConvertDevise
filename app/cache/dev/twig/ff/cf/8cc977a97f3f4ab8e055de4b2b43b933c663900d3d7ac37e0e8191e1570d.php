...
class __TwigTemplate_ffcf8cc977a97f3f4ab8e055de4b2b43b933c663900d3d7ac37e0e8191e1570d extends Twig_Template
{
  ...
  <FORM id=\"currency-selector\" action=\"";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["devise"]) ? $context["devise"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["devise"]) {
            // line 11
            echo "                ";
            if ($this->getAttribute((isset($context["devise"]) ? $context["devise"] : null), "etat")) {
                // line 12
                echo "                    <option value=\"";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["devise"]) ? $context["devise"] : null), "devise"), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["devise"]) ? $context["devise"] : null), "devisedesc"), "html", null, true);
                echo "</option>
                     ";
            }
            // line 14
      ...
      <br> <br> <br> <br> <br>
       ...
       <input  type=\"text\" id=\"montant\"  name=\"_montant\"  >
        ...
        echo "</div>
               ...
               <div class=\"cible\">";
        // line 41
        echo twig_escape_filter($this->env, (isset($context["cour"]) ? $context["cour"] : null), "html", null, true);
        echo " ";
        echo twig_escape_filter($this->env, (isset($context["cible"]) ? $context["cible"] : null), "html", null, true);
        echo "</div>
               </div>            
        ...
        echo twig_escape_filter($this->env, (isset($context["source"]) ? $context["source"] : null), "html", null, true);
        echo "  vaut ";
        echo twig_escape_filter($this->env, ((isset($context["cour"]) ? $context["cour"] : null) * (isset($context["montant"]) ? $context["montant"] : null)), "html", null, true);
        echo " ";
        echo twig_escape_filter($this->env, (isset($context["cible"]) ? $context["cible"] : null), "html", null, true);
        echo "</div>
                </div>
